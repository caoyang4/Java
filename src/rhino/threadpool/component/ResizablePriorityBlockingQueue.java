 ...
 * @since 1.5
 */
public class ResizablePriorityBlockingQueue<E> extends AbstractQueue<E>
     ...
     */
    private volatile int capacity = DEFAULT_INITIAL_CAPACITY;
    /**
     ...
     */
    public ResizablePriorityBlockingQueue() {
     ...
     *                                  than 1
     */
    public ResizablePriorityBlockingQueue(int initialCapacity) {
     ...
     */
    public ResizablePriorityBlockingQueue(Collection<? extends E> c) {
        this.lock = new ReentrantLock();
        this.notEmpty = lock.newCondition();
        ...
        if (c instanceof SortedSet<?>) {
            ...
            heapify = false;
        } else if (c instanceof ResizablePriorityBlockingQueue<?>) {
            ResizablePriorityBlockingQueue<? extends E> pq =
                    (ResizablePriorityBlockingQueue<? extends E>) c;
            this.comparator = (Comparator<? super E>) pq.comparator();
            screen = false;
            if (pq.getClass() == ResizablePriorityBlockingQueue.class) // exact match
                heapify = false;
        }
        Object[] a = c.toArray();
        int n = a.length;
    ...
    static {
        try {
            ...
            UNSAFE = (sun.misc.Unsafe) theUnsafeInstance.get(sun.misc.Unsafe.class);
            Class k = ResizablePriorityBlockingQueue.class;
